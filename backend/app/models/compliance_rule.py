...
class ComplianceRule(Base):
    ...
    min_actual_disbursement_rate = Column(Float, nullable=True, comment="实际到账金额占名义本金最低比例")
    max_term_days = Column(Integer, nullable=True, comment="贷款期限上限")
    max_installment_count = Column(Integer, nullable=True, comment="分期期数上限")
