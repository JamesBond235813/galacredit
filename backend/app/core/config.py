...
class Settings(BaseSettings):
    ...
    HUBTEL_ENABLED: bool = False
    HUBTEL_ACCOUNT_NUMBER: str = ""
    HUBTEL_API_ID: str = ""
    HUBTEL_API_KEY: str = ""
    HUBTEL_INITIATE_URL: str = "https://payproxyapi.hubtel.com/items/initiate"
    HUBTEL_REFUND_URL_TEMPLATE: str = "https://refund-api.hubtel.com/refund/{merchant_account_number}/order/{checkout_id}"
    HUBTEL_TXN_STATUS_URL_TEMPLATE: str = "https://api-txnstatus.hubtel.com/transactions/{merchant_account_number}/status"
    HUBTEL_PAYMENT_CALLBACK_URL: str = ""
    HUBTEL_REFUND_CALLBACK_URL: str = ""
    HUBTEL_RETURN_URL: str = ""
    HUBTEL_CANCELLATION_URL: str = ""
    HUBTEL_HTTP_TIMEOUT_SECONDS: int = 30
