...
def test_admin_partial_routes_should_use_async_and_not_depend_on_sync_db():
    ...
    targets = {
        ...
        "/risk/report",
        "/risk-policies",
        "/risk-policies/{policy_key}/history",
        "/risk-policies/{version_id}",
        "/risk-policies/{version_id}/copy",
        "/risk-policies/{version_id}/activate",
        "/risk-policies/{version_id}/disable",
        "/channels",
        "/channels/{channel_id}",
        "/admin-users/business-advisors",
        "/products",
        "/products/{product_id}",
        "/ecard-pool",
